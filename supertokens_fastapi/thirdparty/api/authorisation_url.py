...
if TYPE_CHECKING:
    from supertokens_fastapi.thirdparty.recipe import ThirdPartyRecipe
...
async def handle_authorisation_url_api(recipe: ThirdPartyRecipe, request: Request):
    third_party_id = request.query_params.get('thirdPartyId', None)
